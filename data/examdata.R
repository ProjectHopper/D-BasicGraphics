...
1set.seed(0923 ); X023 <-round( rnorm( 14 ,111 ,1.7 ),3);
...
2X062 = c("L","L","H","H","L","L","H","H","L","L","H","H","L","L","H","H");
...
#
set.seed(5073);X192<- sample(180:250,n,T)/5;set.seed(5074);X193<-
set.seed(5075);X194<- sample(180:250,n,T)/5;set.seed(5076);X195<-
set.seed(5077);X196<- sample(180:250,n,T)/5;set.seed(5078);X197<-
set.seed(5079);X198<- sample(180:250,n,T)/5;set.seed(5080);X199<-
...
6DAT21 = c(13.1,15.3,25.8,1.8,4.9,55.4,39.3,26.7,47.5,6.6,
...
#
#
7DAT62=c(7692, 7806, 7703, 7876, 7779, 7299, 7174, 7234, 7127,
...
8DAT93=c(130.5, 187.2, 222.5, 190, 185.6, 293.5, 366,475, 381.9, 279.9);
9
